var Utils = {
    ...
    getCanvasWidth: function() {
        ...
        var minWidth = parseInt($("svg").first().css("min-width"))
        minWidth = 200
        return Math.max(minWidth, diff)
    },
    ...
    getCanvasHeight: function() {
        ...
        var minHeight = parseInt($("svg").first().css("min-height"))
        return Math.max(minHeight, diff)
    },
